...
namespace Gefangenendilemma
{
    class VerwaltungProgramm
    {
        ...
        static void Leicht(int aktReaktion1, int aktReaktion2, ref int punkte1, ref int punkte2)
        {
        ...
        static void Mittel(int aktReaktion1, int aktReaktion2, ref int punkte1, ref int punkte2)
        {
            if (aktReaktion1 == BasisStrategie.Kooperieren && aktReaktion2 == BasisStrategie.Kooperieren)
            {
                punkte1 += 10;
        ...
        static void Schwer(int aktReaktion1, int aktReaktion2, ref int punkte1, ref int punkte2)
        {
            if (aktReaktion1 == BasisStrategie.Kooperieren && aktReaktion2 == BasisStrategie.Kooperieren)
            {
                punkte1 += 4;
